...
# Web Automation
    ...
    for line in csv_reader:
        ...
        driver.get('http://www.drtest.net/submit-url')
        driver.maximize_window()
        time.sleep(5)

        freelink = driver.find_element("xpath", '//*[@id="stylized"]/form/input[1]')
        freelink.click()
        time.sleep(5)

        username_field = driver.find_element("xpath", '//*[@id="stylized"]/form/input[17]')
        username_field.send_keys(line[0])
        time.sleep(3)

        Email_field = driver.find_element("xpath", '//*[@id="stylized"]/form/input[18]')
        Email_field.send_keys(line[1])
        time.sleep(3)

        URL_field = driver.find_element("xpath", '//*[@id="stylized"]/form/input[6]')
        URL_field.send_keys(line[2])
        time.sleep(3)

        Title_field = driver.find_element("xpath", '//*[@id="stylized"]/form/input[5]')
        Title_field.send_keys(line[3])
        time.sleep(3)

        Description_field = driver.find_element("xpath", '//*[@id="stylized"]/form/textarea[1]')
