...
# Web Automation
    ...
    for line in csv_reader:
        ...
        driver.get('http://www.directdirectory.org/submit.php')
        ...
        username_field = driver.find_element("xpath", '//*[@id="main"]/div[2]/div[2]/form/table/tbody/tr[4]/td[2]/input')
        ...
        drp.select_by_visible_text("|   |___Internet")
        time.sleep(4)
